...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <div
        className={`fixed md:relative top-0 left-0 flex flex-col h-screen bg-white shadow-2xl w-[280px] md:w-[270px] z-40 transform transition-transform duration-200 ease-in-out md:shadow-lg md:border-r-2 md:border-gray-400 ${
          isMobileOpen
            ? "translate-x-0"
            ...
            <div key={group.groupName} className="mb-4 md:mb-2">
              ...
              {group.groupItems.map(({ id, name, icon, path }) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`text-2xl md:text-xl flex-shrink-0 ${
