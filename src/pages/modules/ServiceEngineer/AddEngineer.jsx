...
const AddEngineer = () => {
  ...
  const handleUpdate = () => {
    ...
    dispatch(addServiceEngineer(payload));
  };
      ...
      <div className=" p-6  flex flex-col gap-8 w-full h-full">
        ...
        <div className="flex justify-center w-full mt-6">
          <button
            ...
            disabled={loading}
            className="bg-[#7EC1B1] text-white px-6 py-3 rounded"
          >
            {loading ? "Adding..." : "Add"}
          </button>
        </div>
...
//     // just log, no API
//     navigate("/service-engineer"); // go back to list
//   };
...
//           <div className="flex-1 flex flex-col gap-2">
//             <label>Skill</label>
//             <select value={skill} onChange={(e) => setSkill(e.target.value)} className="p-3 border border-[#606060] bg-[#F5F5F5] focus:outline-none focus:ring-2 focus:ring-[#7EC1B1]">
//               <option value="">Select Skill</option>
...
//           <div className="flex-1 flex flex-col gap-2">
//             <label>Phone Number</label>
//             <input type="text" value={phone} onChange={(e) => setPhone(e.target.value)} className="p-3 border border-[#606060] bg-[#F5F5F5] focus:outline-none focus:ring-2 focus:ring-[#7EC1B1]" />
//           </div>
//           <div className="flex-1 flex flex-col gap-2">
//             <label>Assigned Area</label>
//             <input type="text" value={assignedArea} onChange={(e) => setAssignedArea(e.target.value)} className="p-3 border border-[#606060] bg-[#F5F5F5] focus:outline-none focus:ring-2 focus:ring-[#7EC1B1]" />
//           </div>
//         </div>
...
//         <div className="flex justify-center w-full mt-6">
//           <button onClick={handleUpdate} className="bg-[#7EC1B1] text-white px-6 py-3 rounded">
//         Add
//           </button>
//         </div>
//       </div>
